    ...
    <section className="section section-alt">
      <div className="container">
        ...
        <div className="grid-2" style={{ gap: 0 }}>
          <div style={{ borderRight: '1px solid #2e2a24', paddingRight: 40 }}>
...
function FeatureRow({ icon, title }) {
  return (
    <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14, padding: '18px 0', borderBottom: '1px solid #2e2a24' }}>
