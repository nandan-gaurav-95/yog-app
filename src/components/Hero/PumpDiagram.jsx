export default function PumpDiagram() {
  return (
    <svg viewBox="0 0 340 300" width="340" height="300" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* ── Base plate ── */}
      <rect x="40" y="230" width="260" height="14" rx="3" fill="#1a1f2e" stroke="#2a2f40" strokeWidth="1.5" />
      <rect x="60"  y="240" width="12" height="20" rx="1" fill="#141820" />
      <rect x="268" y="240" width="12" height="20" rx="1" fill="#141820" />

      {/* ── Motor housing ── */}
      <rect x="45" y="130" width="110" height="102" rx="6" fill="url(#bodyGrad)" stroke="#3a4055" strokeWidth="1.5" />
      <rect x="45" y="130" width="110" height="18"  rx="6" fill="#2e3548" />
      {/* Motor fins */}
      {[0,1,2,3,4].map(i => (
        <rect key={i} x={50 + i * 20} y="150" width="10" height="70" rx="1" fill="#1a1f2e" stroke="#2a2f40" strokeWidth="0.5" opacity="0.6" />
      ))}
      {/* Motor shaft circle */}
      <circle cx="100" cy="190" r="28" fill="#0f131f" stroke="#3a4055" strokeWidth="1.5" />
      <circle cx="100" cy="190" r="18" fill="#0a0d16" stroke="#c8a96e" strokeWidth="1" opacity="0.6" />
      <circle cx="100" cy="190" r="7"  fill="#c8a96e" opacity="0.5" />

      {/* ── Pump head ── */}
      <rect x="165" y="115" width="110" height="118" rx="5" fill="url(#bodyGrad)" stroke="#3a4055" strokeWidth="1.5" />
      ...
      {[[170,120],[265,120],[170,225],[265,225]].map(([x,y],i) => (
        <circle key={i} cx={x} cy={y} r="4" fill="#1a1f2e" stroke="#2a2f40" strokeWidth="1" />
      ))}
      {/* Diaphragm label */}
      ...
      {/* ── Inlet pipe (top) ── */}
      <rect x="220" y="60" width="14" height="58" rx="2" fill="#1a1f2e" stroke="#2a2f40" strokeWidth="1" />
      <rect x="210" y="56" width="34" height="10" rx="2" fill="#2a3040" stroke="#3a4055" strokeWidth="1" />
      ...
      {/* ── Outlet pipe (right) ── */}
      <rect x="275" y="158" width="52" height="14" rx="2" fill="#1a1f2e" stroke="#2a2f40" strokeWidth="1" />
      <rect x="323" y="148" width="10" height="34" rx="2" fill="#2a3040" stroke="#3a4055" strokeWidth="1" />
      ...
      <circle cx="255" cy="108" r="12" fill="#0f131f" stroke="#c8a96e" strokeWidth="1" opacity="0.7" />
      <circle cx="255" cy="108" r="7"  fill="#0a0d16" />
